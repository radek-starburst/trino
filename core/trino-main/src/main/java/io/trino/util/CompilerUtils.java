...
public final class CompilerUtils
{
    ...
    public static <T> Class<? extends T> defineClass(ClassDefinition classDefinition, Class<T> superType, DynamicClassLoader classLoader)
    {
        ...
        return classGenerator(classLoader).dumpClassFilesTo(Path.of("/Users/radek/projects/starburst-and-trino/trino/generated-classes")).defineClass(classDefinition, superType);
