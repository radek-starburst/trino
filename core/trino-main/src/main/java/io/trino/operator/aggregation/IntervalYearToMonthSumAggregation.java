...
public final class IntervalYearToMonthSumAggregation
{
    ...
    @InputFunction
    public static void sum(NullableLongState state, @SqlType(INTERVAL_YEAR_TO_MONTH) long value, @GroupId long groupId)
    {
    ...
    {
        NullableLongState.write(groupId, INTERVAL_YEAR_MONTH, state, out);
    }
}
