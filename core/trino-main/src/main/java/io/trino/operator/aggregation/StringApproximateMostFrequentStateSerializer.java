        ...
        implements AccumulatorStateSerializer<VarcharApproximateMostFrequent.State>
{
    ...
    @Override
    public void serialize(@GroupId long groupId, VarcharApproximateMostFrequent.State state, BlockBuilder out)
    {
        if (state.get() == null) {
            out.appendNull();
        }
    ...
    @Override
    public void deserialize(@GroupId long groupId, Block block, int index, VarcharApproximateMostFrequent.State state)
    {
